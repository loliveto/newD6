...
public class TakeShortQuestion extends Fragment {
    ...
    public static TakeShortQuestion newInstance(Questionare q, Question qu, String name, int qNum) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_take_short, container, false);

        final TextView titleText = view.findViewById(R.id.longprompt);
        titleText.setText(saq.prompt);
